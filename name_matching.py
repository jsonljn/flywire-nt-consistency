"""Match cell-type names using case, whitespace, and range normalization.

Supported range forms include R1-6 and R1-R6. Unsupported names remain
unmatched; fuzzy matching is not used.
"""
import re
